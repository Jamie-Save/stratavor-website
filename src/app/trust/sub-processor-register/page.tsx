...
const ROWS = [
  {
    ...
    purpose: "Hosting, DB, storage",
    data: "Pseudonymised customer data, logs",
    location: "Ireland (primary), EU failover",
    transfer: "EEA processing; SCCs if cross-region",
  },
  {
    service: "Microsoft 365",
    purpose: "Corporate email & docs",
    data: "Business contact, docs",
    location: "EU/EEA (tenant config)",
    transfer: "SCC",
  },
  {
    service: "Stripe",
    purpose: "Payments/billing",
    data: "Billing contact; payment tokens",
    location: "EU + US processing",
    transfer: "SCCs/DPF as applicable",
  },
  {
    service: "HubSpot",
    purpose: "CRM & marketing",
    data: "Lead/contact data",
    location: "EU DC (may use US support)",
    transfer: "SCCs (incl. DPF if applicable)",
  },
  {
    service: "GitHub",
    purpose: "Source control",
    data: "Dev identities; code",
    location: "EU/US",
    transfer: "SCCs/DPF as applicable",
  },
  {
    ...
    data: "Derived metrics & prompts (no raw PII)",
    location: "US",
    transfer: "SCCs Module 3 (processor)",
  },
  {
    service: "Xero",
    purpose: "Accounting data source",
    data: "Financial records; vendor/customer names",
    location: "Customer's region (Xero)",
    transfer: "Customer's own transfer basis",
  },
  {
    service: "QuickBooks Online",
    purpose: "Accounting data source",
    data: "Financial records; vendor/customer names",
    location: "Customer's region (Intuit)",
    transfer: "Customer's own transfer basis",
  },
];
